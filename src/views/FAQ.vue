<template>
    <div class="animated fadeIn">
        <b-row>
            <b-col cols="12" sm="7">
                <b-card v-for="faq of faqs">
                    <b-media>
                        <template v-slot:aside>
                            <b-img src="https://picsum.photos/64" width="64" alt="FAQ"></b-img>
                        </template>

                        <h5 class="mt-0">{{faq.title}}</h5>
            ...
            <b-col sm="5">
                <div class="win-preview fixed-top">
                    <div class="card d-none d-lg-flex card-preview">
                        ...
                        <div class="card-body">
                            <b-img thumbnail fluid src="https://picsum.photos/600" alt="FAQ Preview"></b-img>
                        </div>
                    </div>
                </div>
            </b-col>
